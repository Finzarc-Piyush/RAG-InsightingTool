...
| Plan | Problem | Status |
|------|---------|--------|
| [phase-1-deep-analysis.md](./phase-1-deep-analysis.md) | One-stop in-depth analysis (hypotheses → parallel evidence → ranked drivers → rich answer) | draft |
| [dashboard-ux-collision-fix.md](./dashboard-ux-collision-fix.md) | Dragging a card over another cascades everything; fix to swap semantics + stable reflow | draft |
