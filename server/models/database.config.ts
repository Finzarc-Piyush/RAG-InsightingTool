...
export const waitForAutomationsContainer = async (
  ...
  if (!automationsContainer) {
    throw new Error(
      "CosmosDB automations container not initialized. Please check your COSMOS_ENDPOINT and COSMOS_KEY environment variables and ensure CosmosDB is accessible."
    );
  }
