...
interface DashboardContextType {
  ...
  updateChartInsightOrRecommendation: (dashboardId: string, chartIndex: number, updates: { keyInsight?: string; sort?: { by: "value" | "category"; direction: "asc" | "desc" }; limit?: { mode: "top" | "bottom"; n: number } | null }, sheetId?: string) => Promise<DashboardData>;
