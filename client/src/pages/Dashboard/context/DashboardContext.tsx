...
interface DashboardContextType {
  ...
  updateChartInsightOrRecommendation: (dashboardId: string, chartIndex: number, updates: { keyInsight?: string; sort?: { by: "value" | "category"; direction: "asc" | "desc" }; limit?: { mode: "top" | "bottom"; n: number } | null; type?: string; barLayout?: "grouped" | "stacked"; dataLabels?: boolean }, sheetId?: string) => Promise<DashboardData>;
